...
import { TERMS_OF_SERVICE, getLocalizedLegalContent } from "@/lib/legal/global-legal";
...
export default function TermsOfServiceScreen() {
  ...
  const { title, content, lastUpdated } = getLocalizedLegalContent(TERMS_OF_SERVICE, locale);
